...
|---|---:|---:|---|
| **Authentication & Identity** | 26 | 615 | 24.5% |
| **Billing & Plans** | 20 | 386 | 15.4% |
| **Multi-tenancy & RBAC** | 13 | 238 | 9.5% |
| **Storage & Data Layer** | 21 | 231 | 9.2% |
| **Observability & Health** | 7 | 206 | 8.2% |
| **Messaging & Announcements** | 3 | 151 | 6.0% |
| **Configuration & Branding** | 11 | 131 | 5.2% |
| **Misc / Cross-cutting** | 20 | 126 | 5.0% |
| **Webhooks** | 7 | 98 | 3.9% |
| **Test Suite** | 10 | 92 | 3.7% |
| **Frontend Core (API client / contexts)** | 1 | 52 | 2.1% |
| **Middleware & API Gateway** | 4 | 46 | 1.8% |
| **API Docs & OpenAPI** | 1 | 34 | 1.4% |
| **CLI Tooling** | 3 | 31 | 1.2% |
| **UI Component Library** | 4 | 30 | 1.2% |
| **Admin UI** | 2 | 17 | 0.7% |
| **Deployment & Manifests** | 1 | 14 | 0.6% |
| **Build & Config Files** | 3 | 9 | 0.4% |
...
### Authentication & Identity — 615 nodes across 26 communities
...
### Billing & Plans — 386 nodes across 20 communities
...
### Multi-tenancy & RBAC — 238 nodes across 13 communities
...
### Storage & Data Layer — 231 nodes across 21 communities
...
### Observability & Health — 206 nodes across 7 communities
...
### Messaging & Announcements — 151 nodes across 3 communities
...
### Configuration & Branding — 131 nodes across 11 communities
...
### Misc / Cross-cutting — 126 nodes across 20 communities
...
### Webhooks — 98 nodes across 7 communities
...
### Test Suite — 92 nodes across 10 communities
...
### Frontend Core (API client / contexts) — 52 nodes across 1 communities

- **Community 4** (52 nodes): `Logger`, `.log()`, `Context`, `PMHandler`, `EventDefinitionsHandler`, `.logCategorized()` +46 more

### Middleware & API Gateway — 46 nodes across 4 communities
...
### CLI Tooling — 31 nodes across 3 communities
...
### Admin UI — 17 nodes across 2 communities
